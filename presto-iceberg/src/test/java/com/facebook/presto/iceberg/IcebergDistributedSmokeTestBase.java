        ...
        extends AbstractTestIntegrationSmokeTest
{
    ...
    public void testDeleteUnPartitionedTable()
    {
        ...
        @Language("RegExp") String errorMessage = "This table only supports delete where one or more partitions are deleted entirely. For enabling row level deletions, change the write.delete.mode table property to `merge-on-read`.";
