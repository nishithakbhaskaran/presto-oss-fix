...
primaryExpression
    ...
    // FROM is mandatory, which keeps this alternative unreachable for the trim(source) and
    // trim(source, characters) function call forms. Those keep matching #functionCall above.
